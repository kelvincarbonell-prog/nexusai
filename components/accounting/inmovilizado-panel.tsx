...
const dialog: React.CSSProperties = { width: "min(560px, 100%)", maxHeight: "90vh", overflow: "auto", background: "var(--panel, #fff)", borderRadius: 14, border: "1px solid var(--line, #e5e7eb)", padding: 18, display: "grid", gap: 12 };
